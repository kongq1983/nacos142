...
public class BeatReactor implements Closeable {
    ...
    public void addBeatInfo(String serviceName, BeatInfo beatInfo) {
        ...
        dom2Beat.put(key, beatInfo); // 在finally有会调用executorService.schedule(new BeatTask(beatInfo), nextTime, TimeUnit.MILLISECONDS);
    ...
    class BeatTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                JsonNode result = serverProxy.sendBeat(beatInfo, BeatReactor.this.lightBeatEnabled); // 心跳 /nacos/v1/ns/instance/beat
                ...
                if (code == NamingResponseCode.RESOURCE_NOT_FOUND) {
                    ...
                    try {
                        serverProxy.registerService(beatInfo.getServiceName(),
                                NamingUtils.getGroupName(beatInfo.getServiceName()), instance);  // 资源找不到，则注册
